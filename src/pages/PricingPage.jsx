...
export function PricingPage({ setIsHomePage }) {
  useEffect(() => {
    setIsHomePage(false);
  });
  return (
    <section className="flex flex-col">
      ...
      <div className="flex flex-col bg-[#F6F6F6] items-center justify-center py-10">
        ...
        <div className="flex flex-col w-[80%] lg:w-[22%] items-center justify-center bg-white py-10 mt-10 border-1 border-[#23A6F0]">
        ...
        <div className="flex flex-col w-[80%] lg:w-[22%] h-[664px] items-center justify-center bg-[#252B42] py-10 mt-10 border-1 border-[#23A6F0]">
      ...
      <div className="flex flex-col my-20 items-center justify-center ">
        ...
        <div className="flex flex-col items-center justify-center w-[80%] gap-5 mt-14">
